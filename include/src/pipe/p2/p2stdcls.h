...
RWEXPORT RxClusterDefinition RxClObjSpace3DVertices;
/* Uses the RxCamSpace3DVertex type */
RWEXPORT RxClusterDefinition RxClCamSpace3DVertices;
/* Uses the RxScrSpace2DVertex type (see pipmodel.h) */
RWEXPORT RxClusterDefinition RxClScrSpace2DVertices;
/* Uses the RxInterp type */
RWEXPORT RxClusterDefinition RxClInterpolants;
/* Uses the RxMeshStateVector type */
RWEXPORT RxClusterDefinition RxClMeshState;
/* Uses the RxRenderStateVector type (p2renderstate.c/h) */
RWEXPORT RxClusterDefinition RxClRenderState;
/* Uses the RxVertexIndex type */
RWEXPORT RxClusterDefinition RxClIndices;
/* Uses the RxScatter type */
RWEXPORT RxClusterDefinition RxClScatter;
/* Uses the RxUV type */
RWEXPORT RxClusterDefinition RxClUVs;
/* Uses the RxVStep type */
RWEXPORT RxClusterDefinition RxClVSteps;
/* Uses the RwRGBAReal type */
RWEXPORT RxClusterDefinition RxClRGBAs;
/* Uses the RxCamNorm type */
RWEXPORT RxClusterDefinition RxClCamNorms;

/* Uses the RxTriPlane type.
 * NOTE: this is currently not used in any nodes that ship with the SDK */
RWEXPORT RxClusterDefinition RxClTriPlanes;
