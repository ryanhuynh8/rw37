...
#ifdef RWGLOBALSIZE
RWEXPORT RwUInt32     ourGlobals[RWGLOBALSIZE / sizeof(RwUInt32)];
#define RwEngineInstance ourGlobals
#else /* RWGLOBALSIZE */

#ifdef _RWDLL
__declspec(dllimport) RWEXPORT void         *RwEngineInstance;
#else
RWEXPORT void         *RwEngineInstance;
#endif

#endif /* RWGLOBALSIZE */

#if defined(_RWDLL)
__declspec(dllimport) RWEXPORT RwInt8 _rwMsbBit[];
#else /* defined(_RWDLL) */
RWEXPORT RwInt8 _rwMsbBit[];
