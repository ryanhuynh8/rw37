...
RWEXPORT RwReal RWAPI RwIm2DGetNearScreenZ(void);
RWEXPORT RwReal RWAPI RwIm2DGetFarScreenZ(void);

RWEXPORT RwBool RWAPI RwRenderStateGet(RwRenderState state, void *value);
RWEXPORT RwBool RWAPI RwRenderStateSet(RwRenderState state, void *value);

RWEXPORT RwBool RWAPI RwIm2DRenderLine(RwIm2DVertex *vertices, RwInt32 numVertices, RwInt32 vert1, RwInt32 vert2);
RWEXPORT RwBool RWAPI RwIm2DRenderTriangle(RwIm2DVertex *vertices, RwInt32 numVertices,
                                   RwInt32 vert1, RwInt32 vert2, RwInt32 vert3 );
RWEXPORT RwBool RWAPI RwIm2DRenderPrimitive(RwPrimitiveType primType, RwIm2DVertex *vertices, RwInt32 numVertices);
RWEXPORT RwBool RWAPI RwIm2DRenderIndexedPrimitive(RwPrimitiveType primType, RwIm2DVertex *vertices, RwInt32 numVertices,
