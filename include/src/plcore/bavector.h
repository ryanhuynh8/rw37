...
/****************************************************************************
 Function prototypes
 */
RWEXPORT RwReal RWAPI RwV3dNormalize(RwV3d * out, const RwV3d * in);
RWEXPORT RwReal RWAPI RwV3dLength(const RwV3d * in);

RWEXPORT RwReal RWAPI RwV2dLength(const RwV2d * in);
RWEXPORT RwReal RWAPI RwV2dNormalize(RwV2d * out, const RwV2d * in);

#if ( defined(RWDEBUG) || defined(RWSUPPRESSINLINE) )

RWEXPORT void RWAPI RwV2dAssign(RwV2d * out,
                        const RwV2d * ina);
RWEXPORT void RWAPI RwV2dAdd(RwV2d * out,
                     const RwV2d * ina, const RwV2d * inb);
RWEXPORT void RWAPI RwV2dLineNormal(RwV2d * out,
                     const RwV2d * ina, const RwV2d * inb);
RWEXPORT void RWAPI RwV2dSub(RwV2d * out,
                     const RwV2d * ina, const RwV2d * inb);
RWEXPORT void RWAPI RwV2dPerp(RwV2d * out, const RwV2d * in);
RWEXPORT void RWAPI RwV2dScale(RwV2d * out,
                       const RwV2d * in, RwReal scalar);
RWEXPORT RwReal RWAPI RwV2dDotProduct(const RwV2d * ina, const RwV2d * inb);

RWEXPORT void RWAPI RwV3dAssign(RwV3d * out,
                        const RwV3d * ina);
RWEXPORT void RWAPI RwV3dAdd(RwV3d * out,
                     const RwV3d * ina, const RwV3d * inb);
RWEXPORT void RWAPI RwV3dSub(RwV3d * out,
                     const RwV3d * ina, const RwV3d * inb);
RWEXPORT void RWAPI RwV3dScale(RwV3d * out,
                       const RwV3d * in, RwReal scalar);
RWEXPORT void RWAPI RwV3dIncrementScaled(RwV3d * out,
                                 const RwV3d * in, RwReal scalar);
RWEXPORT void RWAPI RwV3dNegate(RwV3d * out, const RwV3d * in);
RWEXPORT RwReal RWAPI RwV3dDotProduct(const RwV3d * ina, const RwV3d * inb);
RWEXPORT void RWAPI RwV3dCrossProduct(RwV3d * out,
                              const RwV3d * ina, const RwV3d * inb);

#endif         /* ( defined(RWDEBUG) || defined(RWSUPPRESSINLINE) ) */

/* Transform points/vectors */
RWEXPORT RwV3d* RWAPI RwV3dTransformPoint(RwV3d * pointOut,
                                  const RwV3d * pointIn,
                                  const RwMatrix * matrix);
RWEXPORT RwV3d* RWAPI RwV3dTransformPoints(RwV3d * pointsOut,
                                   const RwV3d * pointsIn,
                                   RwInt32 numPoints,
                                   const RwMatrix * matrix);
RWEXPORT RwV3d* RWAPI RwV3dTransformVector(RwV3d * vectorOut,
                                   const RwV3d * vectorIn,
                                   const RwMatrix * matrix);
RWEXPORT RwV3d* RWAPI RwV3dTransformVectors(RwV3d * vectorsOut,
...
RWEXPORT RwReal RWAPI _rwSqrt(const RwReal num);
#endif /* (!defined(RWNOSQRTTABLE)) */
#if (!defined(RWNOINVSQRTTABLE))
RWEXPORT RwReal RWAPI _rwInvSqrt(const RwReal num);
#endif /* (!defined(RWNOINVSQRTTABLE)) */

RWEXPORT RwReal RWAPI _rwV3dNormalize(RwV3d * out, const RwV3d * in);

/* RWPUBLICEND */

/* Opening and closing */
RWEXPORT void* RWAPI _rwVectorOpen(void *instance,
                           RwInt32 offset, RwInt32 size);
RWEXPORT void* RWAPI _rwVectorClose(void *instance,
                            RwInt32 offset, RwInt32 size);

#if !defined(RWNOVECMULTFUNCS)
RWEXPORT RwBool RWAPI _rwVectorSetMultFn(rwVectorMultFn multPoint,
                                 rwVectorsMultFn multPoints,
                                 rwVectorMultFn multVector,
                                 rwVectorsMultFn multVectors);
#endif /* !defined(RWNOVECMULTFUNCS) */
